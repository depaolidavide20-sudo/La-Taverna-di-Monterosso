...
test("static HTML contains the La Taverna website", async () => {
  ...
  assert.match(html, /data-i18n="story\.kicker">01 La nostra storia/);
  assert.match(html, /data-i18n="restaurant\.kicker">02 Ristorante/);
  assert.match(html, /data-i18n="location\.kicker">03 Location/);
  assert.match(html, /data-i18n="luggage\.kicker">04 Deposito bagagli/);
  ...
  assert.match(html, /WhatsApp e Google Maps vengono aperti o caricati solo se accetti i servizi esterni/);
