...
test("static HTML contains the La Taverna website", async () => {
  ...
  assert.match(html, /id="storia"[\s\S]*assets\/story-chefs-plating\.png[\s\S]*assets\/story-chefs-fish\.png[\s\S]*La mia storia in cucina inizia nel lontano <strong>1982<\/strong>[\s\S]*quattro ristoranti[\s\S]*Solo osservando tutti i piccoli dettagli[\s\S]*id="ristorante"/);
...
test("static assets are self-contained and scoped", async () => {
  ...
  assert.match(css, /\.luggage-service-lines/);
